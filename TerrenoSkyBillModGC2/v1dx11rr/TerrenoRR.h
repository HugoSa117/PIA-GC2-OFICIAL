...
public:
	TerrenoRR(int ancho, int alto, ID3D11Device* D3DDevice, ID3D11DeviceContext* D3DContext)
	{
		...
		CargaParametros( L"Assets/Texturas/Ground_Forest_003_baseColor.jpg", 
			L"Assets/Texturas/Ground_Forest_003_normal.jpg",
			L"Assets/Texturas/Mud_Rocks_001_Color.jpg",
			L"Assets/Texturas/Mud_Rocks_001_normal.jpg", 
			L"Assets/Texturas/Stone_Path_006_basecolor.jpg",
	...
	void Draw(D3DXMATRIX vista, D3DXMATRIX proyeccion)
	{
		...
		d3dContext->PSSetShaderResources(4, 1, &colorMap3);
		d3dContext->PSSetShaderResources(5, 1, &normalMap3);
		d3dContext->PSSetShaderResources( 6, 1, &blendMap );
		d3dContext->PSSetShaderResources(7, 1, &blendMap2);
