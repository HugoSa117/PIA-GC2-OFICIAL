...
private:
	...
	struct LightBuffer {
		...
		D3DXVECTOR4 blednWater = D3DXVECTOR4(1, 0, 0, 1);
	};
...
public:
	Water(int ancho, int alto, ID3D11Device* D3DDevice, ID3D11DeviceContext* D3DContext)
	{
		...
		CargaParametros(
			L"Assets/Texturas/Water_001_COLOR.jpg",
			L"Assets/Texturas/Water_001_NORM.jpg",
			L"Assets/Texturas/Water_001_SPEC.jpg",
			L"Assets/Texturas/Water_002_COLOR.png",
			L"Assets/Texturas/Water_002_NORM.png",
			L"Assets/Texturas/Water_002_SPEC.png",
			L"Assets/Texturas/terrenoAgua.png",
			20.0f);
	}
	...
	)
	{
		...
		lighBuffer.blednWater.x = blendText;
		...
		d3dContext->PSSetShaderResources(2, 1, &specularMap);
		d3dContext->PSSetShaderResources(3, 1, &colorMap2);
		d3dContext->PSSetShaderResources(4, 1, &normalMap2);
		d3dContext->PSSetShaderResources(5, 1, &specularMap2);
		...
		d3dContext->VSSetConstantBuffers(4, 1, &lightDirCB);

		//cantidad de trabajos
		int cuenta = (anchoTexTerr - 1) * (altoTexTerr - 1) * 10;
